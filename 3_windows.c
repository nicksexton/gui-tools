...
int main (int argc, char *argv[]) {
  ...
  // creates a label, aligned to the left. 
  // Place in first row of GtkTable container
  ...
  // Text view widget spans two rows and two columns. 
  // Make widget non-editable and hide the cursor
  ...
  // put the close button next to the text view widget into the fourth column
  // add button into the alignment widget, so that we can align it to the top
